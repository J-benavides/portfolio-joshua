...
export const T = {
  en: {
    ...
    about: {
      ...
      bio2: 'I thrive in distributed, agile environments where proactive self-management is key. Actively advancing my English fluency (B1) to collaborate seamlessly across international remote teams and deliver maintainable clean code.',
  ...
  es: {
    ...
    about: {
      ...
      bio2: 'Prospero en entornos remotos y distribuidos mediante una autogestión proactiva. Mantengo un desarrollo constante de fluidez profesional en inglés (B1) para integrarme eficazmente a equipos globales y entregar código limpio.',
